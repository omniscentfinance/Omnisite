...
const INDICATORS = [
  ...
  { label: "USA · ISM Manufacturing PMI", symbol: "ECONOMICS:USMPMI" },
  { label: "USA · ISM Services PMI", symbol: "ECONOMICS:USNMPMI" },
  { label: "USA · Core CPI (YoY)", symbol: "ECONOMICS:USCIR" },
  { label: "USA · Consumer Sentiment (Michigan)", symbol: "ECONOMICS:UMCSENT" },
