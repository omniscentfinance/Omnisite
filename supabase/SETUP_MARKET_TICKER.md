...
Silver, EUR/USD, DXY, WTI) usa i dati di **Twelve Data** tramite una
...
- Piano free: 8 richieste/minuto — il ticker fa 1 sola richiesta (batch di
  8 simboli) ogni volta che viene ricaricato, quindi è ampiamente sufficiente.
...
## Simboli usati
Alcuni simboli "puri" (DXY spot, XAG/USD) non sono disponibili nel piano
free di Twelve Data: usiamo ETF/coppie equivalenti.
...
VIX è stato rimosso: non era disponibile in nessuna variante affidabile
nel piano gratuito.
